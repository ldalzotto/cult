...
static void test_lzss_window_size_boundary(test_context* t) {
    ...
    TEST_ASSERT(t, compressed_size == 45, "Compression should work");
    ...
    TEST_ASSERT(t, sa_equals(&alloc, decompressed, (char*)decompressed + decompressed_size, input.begin, input.end), "Decompressed content should match input");
...
static void test_lzss_large_input(test_context* t) {
    ...
    uptr compressed_size = bytesize(out, alloc.cursor);
    TEST_ASSERT(t, compressed_size == 49, "Compression should work");
    TEST_ASSERT(t, compressed_size <= input_size, "Compressed size should not exceed input for repeating pattern");
...
static void test_lzss_all_identical(test_context* t) {
    ...
    uptr compressed_size = bytesize(out, alloc.cursor);
    TEST_ASSERT(t, compressed_size == 37, "Should compress well with identical bytes");
...
static void test_lzss_alternating_pattern(test_context* t) {
    ...
    uptr compressed_size = bytesize(out, alloc.cursor);
    TEST_ASSERT(t, compressed_size == 30, "Compression should work");
...
static void test_lzss_minimum_match(test_context* t) {
    ...
    uptr compressed_size = bytesize(out, alloc.cursor);
    TEST_ASSERT(t, compressed_size == 18, "Compression should work");
...
static void test_lzss_small_repetitions(test_context* t) {
    ...
    uptr compressed_size = bytesize(out, alloc.cursor);
    TEST_ASSERT(t, compressed_size == 10, "Compression should work");
...
static void test_lzss_config_variations(test_context* t) {
    ...
    uptr compressed_size = bytesize(out, alloc.cursor);
    TEST_ASSERT(t, compressed_size == 13, "Compression should work");
...
static void test_lzss_match_size_max_boundary(test_context* t) {
    ...
    uptr compressed_size = bytesize(out, alloc.cursor);
    TEST_ASSERT(t, compressed_size == 50, "Compression should work");
...
static void test_lzss_random_binary(test_context* t) {
    ...
    uptr compressed_size = bytesize(out, alloc.cursor);
    TEST_ASSERT(t, compressed_size == 267, "Compression should work");
...
static void test_lzss_empty_input(test_context* t) {
    ...
    TEST_ASSERT(t, sa_equals(&alloc, decompressed, (char*)decompressed + decompressed_size, input.begin, input.end), "Decompressed content should match input (empty)");
